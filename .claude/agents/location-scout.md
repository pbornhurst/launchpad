...
> You are a data analyst. Execute the following Snowflake queries using the Bash tool: `python3 scripts/snowflake_query.py --json "SQL_HERE"` (direct Snowflake via PAT auth, no OAuth drops). Return the structured results.
>
> **City:** [CITY]
> **State:** [STATE_ABBREV]
